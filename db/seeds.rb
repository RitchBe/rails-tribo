...
FEATURES = ["High-speed Wi-Fi", "Coffee&Tea", "FridayBeers", "Printers", "Outlets", "Host", "Meeting Rooms","Bicycle Lodge",
...
RULES = ["Smoking not allowed", "Pets allowed","No ??", "Instant Booking", "Early Dinner Access", "Networking",
"Restaurant Disscount"]
